...
public class WorldGenTigersEye extends WorldGenMinable{

	private static final int VEIN_SIZE = 1;
	private static final int SPAWNTRIES = 10;
	private static final int MIN_HEIGHT = 0;
	private static final int MAX_HEIGHT = 200;
	
    public WorldGenTigersEye(IBlockState state, Predicate<IBlockState> predicate){
