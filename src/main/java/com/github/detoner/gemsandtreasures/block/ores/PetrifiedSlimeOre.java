...
import com.github.detoner.gemsandtreasures.handler.registration.PetrifiedSlimeballRegistration;
...
public class PetrifiedSlimeOre extends BlockBase {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return PetrifiedSlimeballRegistration.petrified_slimeball;
	}
