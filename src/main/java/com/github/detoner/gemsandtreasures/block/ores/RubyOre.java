...
import com.github.detoner.gemsandtreasures.handler.registration.RubyRegistration;
...
public class RubyOre extends BlockBase {
	...
	public RubyOre(Material material, String name) {
		super(material, name);
		setHardness(3.0f);
		setResistance(3.0f);
