package net.detoner.gemsandtreasures;

import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;

import net.detoner.gemsandtreasures.addon.ChiselAddon;
import net.detoner.gemsandtreasures.fallinganvil.FallingAnvilRecipeRegistration;
import net.detoner.gemsandtreasures.handler.EntityHandler;
import net.detoner.gemsandtreasures.handler.LootHandler;
import net.detoner.gemsandtreasures.handler.OreDictionaryHandler;
import net.detoner.gemsandtreasures.handler.RegistrationHandler;
import net.detoner.gemsandtreasures.handler.RenderingHandler;
import net.detoner.gemsandtreasures.handler.SmeltingHandler;
import net.detoner.gemsandtreasures.handler.WorldGenHandler;
