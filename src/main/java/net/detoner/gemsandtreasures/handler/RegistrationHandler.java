...
import net.detoner.gemsandtreasures.block.AmethystOre;
import net.detoner.gemsandtreasures.block.AquamarineClayOre;
import net.detoner.gemsandtreasures.block.AquamarineOre;
import net.detoner.gemsandtreasures.block.BlockBase;
import net.detoner.gemsandtreasures.block.BlockBaseGlass;
import net.detoner.gemsandtreasures.block.CarbonadoOre;
import net.detoner.gemsandtreasures.block.CoalStoneOre;
import net.detoner.gemsandtreasures.block.CrystalOre;
import net.detoner.gemsandtreasures.block.FireJadeOre;
import net.detoner.gemsandtreasures.block.GlowingGemOre;
import net.detoner.gemsandtreasures.block.ItemBlockBase;
import net.detoner.gemsandtreasures.block.JadeOre;
import net.detoner.gemsandtreasures.block.MoonCrystalOre;
import net.detoner.gemsandtreasures.block.OnyxOre;
import net.detoner.gemsandtreasures.block.OnyxSoulSandOre;
import net.detoner.gemsandtreasures.block.RoseQuartzOre;
import net.detoner.gemsandtreasures.block.RubyOre;
import net.detoner.gemsandtreasures.block.SapphireOre;
import net.detoner.gemsandtreasures.block.TigersEyeOre;
import net.detoner.gemsandtreasures.block.TigersEyeSandOre;
import net.detoner.gemsandtreasures.block.TopazDirtOre;
import net.detoner.gemsandtreasures.block.TopazOre;
import net.detoner.gemsandtreasures.block.TopazSoulSandOre;
import net.detoner.gemsandtreasures.block.VoidJadeOre;
import net.detoner.gemsandtreasures.item.ItemBase;
import net.detoner.gemsandtreasures.item.ItemBaseArmor;
import net.detoner.gemsandtreasures.item.ItemBaseAxe;
import net.detoner.gemsandtreasures.item.ItemBaseHoe;
import net.detoner.gemsandtreasures.item.ItemBasePickaxe;
import net.detoner.gemsandtreasures.item.ItemBaseShovel;
import net.detoner.gemsandtreasures.item.ItemBaseSword;
import net.detoner.gemsandtreasures.item.ItemJade;
import net.detoner.gemsandtreasures.item.ItemScrollOfReturn;
import net.detoner.gemsandtreasures.item.material.ModMaterial;
import net.detoner.gemsandtreasures.settings.CarbonadoSettings;
import net.detoner.gemsandtreasures.settings.GemsSettings;
import net.detoner.gemsandtreasures.settings.JadeSettings;
import net.detoner.gemsandtreasures.settings.MarbleSettings;
import net.detoner.gemsandtreasures.settings.TigersEyeSettings;
import net.detoner.gemsandtreasures.settings.TreasuresSettings;
...
public class RegistrationHandler {
	...
	public static Block onyx_soul_sand_ore;
	//end onyx
	...
	public static void initBlocks() {
		...
		if(GemsSettings.settings.onyxEnabled) {
			...
			blocks.add(onyx_ore);
			onyx_soul_sand_ore = new OnyxSoulSandOre(Material.ROCK, "onyx_soul_sand_ore");
			blocks.add(onyx_soul_sand_ore);
		}
		//end onyx
